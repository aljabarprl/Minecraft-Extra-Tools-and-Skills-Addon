...
execute as @a[tag=blast] at @s run playsound mace.smash_ground @a[r=15] ~ ~ ~ 5
execute as @a[tag=blast] at @s run effect @e[tag=!blast,type=!armor_stand,type=!item,type=!xp_orb,type=!falling_block,r=5,c=10] slowness 2 2 true
...
execute as @e[tag=!blast,type=!armor_stand,type=!item,type=!xp_orb,type=!falling_block,r=5] run damage @s 20 entity_explosion
