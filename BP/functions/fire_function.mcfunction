...
execute as @a[tag=fire] at @s run playsound mace.smash_ground @a[r=15] ~ ~ ~
execute as @a[tag=fire] at @s run playsound random.fizz @a[r=15] ~ ~ ~ 
execute as @a[tag=fire] at @s run playsound fire.fire @a[r=10] ~ ~ ~
execute at @e[tag=!fire,type=!item,type=!xp_orb,type=!armor_stand,type=!falling_block,r=5] run damage @s[tag=!fire,r=5] 10 fire_tick
