...
effect @e[type=pillager,c=1] absorption infinite 5 true
effect @e[type=pillager,c=1] regeneration infinite 5 true
effect @e[type=pillager,c=1] strength infinite 10 true
effect @e[type=pillager,c=1] resistance 5 1 true
...
ride @e[type=pillager,c=1] summon_ride ravager