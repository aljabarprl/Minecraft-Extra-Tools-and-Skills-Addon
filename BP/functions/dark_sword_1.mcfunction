...
execute as @a[tag=darksword] at @s run effect @e[tag=!darksword,type=!armor_stand,type=!item,type=!xp_orb,type=!falling_block,r=5,c=10] blindness 2 1 true
