...
replaceitem entity @e[type=ravager,c=1] slot.armor.head 1 netherite_helmet
replaceitem entity @e[type=ravager,c=1] slot.armor.body 1 netherite_chestplate
replaceitem entity @e[type=ravager,c=1] slot.armor.legs 1 netherite_leggings
replaceitem entity @e[type=ravager,c=1] slot.armor.feet 1 netherite_boots
