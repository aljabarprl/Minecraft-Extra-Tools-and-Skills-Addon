...
execute as @a[tag=emerald] at @s run playsound break.amethyst_cluster @a[r=15] ~ ~ ~
execute as @a[tag=emerald] at @s run playsound mace.smash_air @a[r=15] ~ ~ ~
...
execute as @a[tag=emerald] at @s run effect @e[tag=!emerald,type=!armor_stand,type=!item,type=!xp_orb,type=!falling_block,r=5,c=10] poison 3 255 true
execute as @a[tag=emerald] at @s run effect @e[tag=!emerald,type=!armor_stand,type=!item,type=!xp_orb,type=!falling_block,r=5,c=10] oozing 15 1 true
execute as @a[tag=emerald] at @s run effect @e[tag=!emerald,type=!armor_stand,type=!item,type=!xp_orb,type=!falling_block,r=5,c=10] blindness 3 1 true
execute as @a[tag=emerald] at @s run effect @e[tag=!emerald,type=!armor_stand,type=!item,type=!xp_orb,type=!falling_block,r=5,c=10] hunger 10 5 true

execute as @e[tag=!emerald,type=!armor_stand,type=!item,type=!xp_orb,type=!falling_block,r=5] run damage @s[r=5] 10 magic
...
effect @p health_boost 8 4 true
